(function () {
  ...
  function renderLiveCard(entry, youtubeUrl) {
    ...
    thumb.appendChild(el("span", { cls: "play-badge", text: "Live" }));
    card.appendChild(thumb);

    var body = el("div", { cls: "card-live-body" });
    body.appendChild(el("span", { cls: "card-live-tag", text: "Episode " + entry.num + " — Live" }));
    ...
    var btn = el("span", { cls: "btn btn-primary", text: "Watch on YouTube ↗" });
  ...
  function renderRoadmap(data) {
    ...
    if (totalsEl) {
      ...
      totalsEl.innerHTML =
        "<strong>" + totalLive + "</strong> live · " +
        "<strong>" + totalPlanned + "</strong> works planned · " +
        "<strong>≈ " + grand + "</strong> total episodes at full build-out.";
    }
  }
